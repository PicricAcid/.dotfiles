...
var installCmd = &cobra.Command{
	...
	Long: `指定されたパッケージを skill-hunter-packages.nix に追加し、home-manager switch を実行してインストールします。

例:
 skill_hunter install ripgrep
 skill_hunter install fzf`,
...
func runInstall(cmd *cobra.Command, args []string) error {
	...
	fmt.Println("☑️ skill-hunter-packages.nix に追加しました")
